	...
	return (
		<div className="relative min-h-screen bg-zinc-950 text-zinc-100 overflow-hidden">
			...
			<div className="relative z-10 max-w-4xl mx-auto px-6 py-12 space-y-12">
				<div>
					<h1 className="text-3xl font-bold mb-2">Notification Component Showcase</h1>
				...
				<section className="space-y-4">
					...
					<p className="text-xs text-zinc-500">Notifications can include an optional title</p>
					<div className="flex flex-wrap gap-3">
						<Button
							variant="primary"
							size="md"
				...
				{/* With Action */}
				<section className="space-y-4">
					<h2 className="text-xl font-semibold text-zinc-200">With Action Button</h2>
					<p className="text-xs text-zinc-500">
				...
				{/* Custom Duration */}
				<section className="space-y-4">
					<h2 className="text-xl font-semibold text-zinc-200">Custom Duration</h2>
					<p className="text-xs text-zinc-500">Control how long notifications stay visible</p>
					<div className="flex flex-wrap gap-3">
						<Button
							variant="primary"
							size="md"
				...
				{/* Non-Dismissible */}
				<section className="space-y-4">
					<h2 className="text-xl font-semibold text-zinc-200">Non-Dismissible</h2>
					<p className="text-xs text-zinc-500">Notifications that cannot be manually dismissed</p>
					<div className="flex flex-wrap gap-3">
						<Button
							variant="primary"
							size="md"
				...
				<section className="space-y-4">
					<h2 className="text-xl font-semibold text-zinc-200">Multiple Notifications</h2>
					<p className="text-xs text-zinc-500">Show multiple notifications at once (stacked)</p>
					<div className="flex flex-wrap gap-3">
						<Button
							variant="primary"
							size="md"
				...
				<section className="space-y-4">
					...
					<p className="text-xs text-zinc-500">Common use cases for notifications</p>
					<div className="space-y-3">
						...
						<Button
							...
							onClick={() =>
								showNotification({
									...
									message: "Unable to create task. Please check your connection and try again.",
									variant: "error",
									action: {
										label: "Retry",
										onClick: () => {
						...
						<Button
							...
							onClick={() =>
								showNotification({
									title: "XP Earned",
									message: 'You earned 50 XP for completing "Review project proposal"',
									variant: "success",
									action: {
										label: "View Profile",
										onClick: () => {
