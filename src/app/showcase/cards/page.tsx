...
export default function CardsShowcasePage() {
		...
		<div className="relative min-h-screen bg-zinc-950 text-zinc-100 overflow-hidden">
			...
			<div className="relative z-10 max-w-4xl mx-auto px-6 py-12 space-y-12">
				<div>
					...
					<p className="text-sm text-zinc-400">Display of Card component variants and use cases</p>
				</div>
				...
				<section className="space-y-4">
					...
					<div className="space-y-4">
						<Card variant="primary">
							<p className="text-sm text-zinc-300">Primary variant - Default card with shadow</p>
						</Card>
						<CodeSnippet
  ...
  <p className="text-sm text-zinc-300">
    Secondary variant - Section card with larger radius
						...
						/>
						<Card variant="danger">
							<p className="text-sm">Danger variant - Error/alert card with rose styling</p>
						</Card>
						<CodeSnippet
  ...
  <p className="text-sm">
    Danger variant - Error/alert card with rose styling
				...
				<section className="space-y-4">
					...
					<p className="text-xs text-zinc-500">Card with just content, no header</p>
					<Card variant="primary">
						<div className="space-y-3">
							<h3 className="text-lg font-semibold">Simple Content</h3>
							<p className="text-sm text-zinc-400">
								This is a simple card wrapper. It provides a consistent background, border, and
								padding for content.
							</p>
						</div>
					</Card>
  ...
  <div className="space-y-3">
    ...
    <p className="text-sm text-zinc-400">
      ...
      background, border, and padding for content.
				...
				{/* Card with Title */}
				<section className="space-y-4">
					<h2 className="text-xl font-semibold text-zinc-200">Card with Title</h2>
					<p className="text-xs text-zinc-500">Card with title in header</p>
					<Card variant="secondary" title="Task List">
						<p className="text-sm text-zinc-400">Content area (header will appear above this)</p>
					</Card>
					<CodeSnippet
  ...
  <p className="text-sm text-zinc-400">
    Content area (header will appear above this)
				...
				<section className="space-y-4">
					<h2 className="text-xl font-semibold text-zinc-200">Card with Title and Label</h2>
					<p className="text-xs text-zinc-500">Card with label (eyebrow) and title</p>
  ...
  <p className="text-sm text-zinc-400">
    Content area (header with label and title will appear above this)
				...
				{/* Card with Action */}
				<section className="space-y-4">
					<h2 className="text-xl font-semibold text-zinc-200">Card with Action</h2>
...
>
  <p className="text-sm text-zinc-400">
    Content area (header with action will appear above this)
				...
				<section className="space-y-4">
					<h2 className="text-xl font-semibold text-zinc-200">Card with Multiple Actions</h2>
					<p className="text-xs text-zinc-500">Card with array of action buttons</p>
					<Card
						variant="secondary"
...
>
  <p className="text-sm text-zinc-400">
    Content area (header with multiple actions will appear above this)
				...
				<section className="space-y-4">
					<h2 className="text-xl font-semibold text-zinc-200">Card with Full Header</h2>
					<p className="text-xs text-zinc-500">Card with label, title, and action</p>
					<Card
						variant="secondary"
						title="Task List"
						label="Overview"
  ...
  <div className="space-y-2">
    ...
    <div className="rounded-lg border border-white/5 bg-white/5 p-3">
      <p className="text-sm text-zinc-300">Another task item</p>
				...
				{/* Responsive Padding */}
				<section className="space-y-4">
					<h2 className="text-xl font-semibold text-zinc-200">Responsive Padding</h2>
					<p className="text-xs text-zinc-500">Card with responsive padding (like AuthCard)</p>
  ...
  <div className="space-y-3">
    ...
    <p className="text-sm text-zinc-400">
      This card uses responsive padding (p-6 on mobile, p-8 on larger screens)
				...
				{/* Danger Variant */}
				<section className="space-y-4">
					<h2 className="text-xl font-semibold text-zinc-200">Danger Variant</h2>
					<p className="text-xs text-zinc-500">Card for error messages and alerts</p>
					<Card variant="danger">
						<div className="space-y-2">
							<h3 className="text-lg font-semibold">Error Message</h3>
							<p className="text-sm">
								This card is used for displaying error messages, validation errors, or warning
								alerts.
							</p>
						</div>
					</Card>
    ...
    <p className="text-sm">
      ...
      errors, or warning alerts.
				...
				<section className="space-y-4">
					...
					<p className="text-xs text-zinc-500">Card with different semantic elements</p>
					<div className="space-y-4">
...
<Card as="article" variant="primary" title="Article Element">
  <p className="text-sm text-zinc-400">Renders as &lt;article&gt;</p>
				...
				<section className="space-y-4">
					<h2 className="text-xl font-semibold text-zinc-200">Side by Side Comparison</h2>
					<p className="text-xs text-zinc-500">New Card component vs Legacy components</p>
					<div className="grid grid-cols-1 md:grid-cols-2 gap-4">
						<div className="space-y-2">
							<h3 className="text-sm font-medium text-zinc-400">New Card (Primary)</h3>
							<Card variant="primary">
								<p className="text-sm text-zinc-300">New unified Card component</p>
							</Card>
						</div>
						<div className="space-y-2">
							...
							<Card variant="primary" responsivePadding>
								<p className="text-sm text-zinc-300">
									Equivalent to legacy AuthCard: Card with variant=&quot;primary&quot; and
									responsivePadding
								</p>
							</Card>
						</div>
						<div className="space-y-2">
							<h3 className="text-sm font-medium text-zinc-400">New Card (Secondary)</h3>
							<Card variant="secondary" title="Section Title" label="Label">
								<p className="text-sm text-zinc-300">New Card with header</p>
							</Card>
						</div>
						<div className="space-y-2">
							<h3 className="text-sm font-medium text-zinc-400">Legacy TaskSectionCard</h3>
							<TaskSectionCard title="Section Title" eyebrow="Label">
								<p className="text-sm text-zinc-300">Legacy TaskSectionCard component</p>
							</TaskSectionCard>
						</div>
					</div>
					<CodeSnippet
...
>
  {/* Content hidden while loading */}
						...
						<Card variant="primary" title="Simple Loading" loading={true}>
							<p className="text-sm text-zinc-300">This content is hidden while loading</p>
						</Card>
						<CodeSnippet
  ...
  <p className="text-sm text-zinc-300">
    This content is hidden while loading
				...
				{/* Legacy Components */}
				<section className="space-y-4">
					<h2 className="text-xl font-semibold text-zinc-200">Legacy Components</h2>
					<p className="text-xs text-zinc-500">Original components for reference</p>
					<div className="space-y-4">
						<div>
							...
							<Card variant="primary" responsivePadding>
								<div className="space-y-3">
									<h3 className="text-lg font-semibold">Simple Content</h3>
									<p className="text-sm text-zinc-400">
										Replaces legacy AuthCard: use Card with variant=&quot;primary&quot; and
										responsivePadding
									</p>
								</div>
							</Card>
  ...
  <div className="space-y-3">
    ...
    <p className="text-sm text-zinc-400">
      ...
      variant="primary" and responsivePadding
						...
						<div>
							<h3 className="text-sm font-medium text-zinc-400 mb-2">TaskSectionCard (Legacy)</h3>
							<TaskSectionCard
								title="Task List"
								eyebrow="Overview"
								action={
							...
							>
								<p className="text-sm text-zinc-400">Legacy TaskSectionCard component</p>
							</TaskSectionCard>
							<CodeSnippet
