...
import { IoHeart, IoMail, IoNotifications, IoPersonAdd, IoStar } from "react-icons/io5";
		...
		<div className="relative min-h-screen bg-zinc-950 text-zinc-100 overflow-hidden">
			...
			<div className="relative z-10 max-w-4xl mx-auto px-6 py-12 space-y-12">
				...
				<section className="space-y-4">
					...
					<p className="text-xs text-zinc-500">Different spinner types for loading states</p>
				...
				<section className="space-y-4">
					<h2 className="text-xl font-semibold text-zinc-200">Icon Buttons with Badges</h2>
					<p className="text-xs text-zinc-500">
						Using the <code className="text-zinc-400">icon</code> and{" "}
						<code className="text-zinc-400">badgeCount</code> props for notification-style icon
						buttons
					</p>
					<div className="space-y-4">
						<div>
							<h3 className="text-sm font-medium text-zinc-300 mb-3">Icon Only</h3>
							<div className="flex items-center gap-3">
								<Button icon={IoMail} title="Messages" aria-label="Messages" />
								<Button icon={IoNotifications} title="Notifications" aria-label="Notifications" />
								<Button icon={IoPersonAdd} title="Friend Requests" aria-label="Friend requests" />
							</div>
						</div>
						<div>
							<h3 className="text-sm font-medium text-zinc-300 mb-3">With Badges</h3>
							<div className="flex items-center gap-3">
								<Button
									icon={IoMail}
									badgeCount={2}
						...
						<div>
							<h3 className="text-sm font-medium text-zinc-300 mb-3">Large Badge Counts</h3>
							<div className="flex items-center gap-3">
								<Button
									icon={IoMail}
									badgeCount={99}
								...
								/>
								<Button icon={IoStar} badgeCount={0} title="Favorites" aria-label="Favorites" />
							</div>
						</div>
						<div>
							<h3 className="text-sm font-medium text-zinc-300 mb-3">Disabled State</h3>
							<div className="flex items-center gap-3">
								<Button
									icon={IoMail}
									badgeCount={3}
...
/>`}</code>
				...
				<section className="space-y-4">
					<h2 className="text-xl font-semibold text-zinc-200">Stacked Layout (OAuth Example)</h2>
					<p className="text-xs text-zinc-500">
						Using the <code className="text-zinc-400">stack</code> prop to display icon above text,
						perfect for OAuth buttons
					</p>
				...
				<section className="space-y-4">
					<h2 className="text-xl font-semibold text-zinc-200">Legacy Component</h2>
