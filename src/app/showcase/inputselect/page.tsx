...
export default function InputSelectShowcasePage() {
	...
	const [priorityValue, setPriorityValue] = useState<"low" | "medium" | "high">("low");
	...
	return (
		<div className="relative min-h-screen bg-zinc-950 text-zinc-100 overflow-hidden">
			...
			<div className="relative z-10 max-w-4xl mx-auto px-6 py-12 space-y-12">
				<div>
					<h1 className="text-3xl font-bold mb-2">InputSelect Component Showcase</h1>
				...
				<section className="space-y-4">
					...
					<div className="space-y-4">
						<div className="rounded-2xl border border-white/10 bg-white/5 p-6 space-y-4">
							<h3 className="text-sm font-semibold text-zinc-300">InputSelect</h3>
							<InputSelect
								label="Category"
								value={categoryValue}
								onChange={setCategoryValue}
							...
							<p className="text-xs text-zinc-500">
								...
								<br />✅ Consistent variant/size system
