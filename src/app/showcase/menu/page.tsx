...
export default function MenuShowcasePage() {
						...
						<div className="space-y-4">
							<div className="flex items-center gap-4">
								...
								{selectedAction && (
									<p className="text-sm text-zinc-400">
										Last action:{" "}
										<span className="font-semibold text-zinc-200">{selectedAction}</span>
									</p>
								)}
							</div>
  ...
  />
				...
				{/* Variants & Sizes */}
				<section className="space-y-4">
					<h2 className="text-xl font-semibold text-zinc-200">Variants & Sizes</h2>
					<Card variant="primary" responsivePadding>
						<div className="space-y-6">
							<div>
								<h3 className="text-sm font-medium text-zinc-300 mb-3">Variants</h3>
							...
							<div>
								<h3 className="text-sm font-medium text-zinc-300 mb-3">Sizes</h3>
								<div className="flex flex-wrap items-center gap-4">
  ...
  <MenuItem label="Item" icon={<Icon />} href="/" />
				...
				<section className="space-y-4">
					...
					<Card variant="primary" responsivePadding>
						<div className="space-y-4">
							<h3 className="text-sm font-medium text-zinc-300">Badges & Notifications</h3>
							<Menu triggerLabel="With Badges" triggerBadgeCount={15}>
								<MenuItem label="Messages" icon={<FiMail />} href="/messages" badgeCount={3} />
								<MenuItem
									label="Notifications"
									icon={<FiBell />}
									href="/notifications"
  ...
  />
					...
					<Card variant="primary" responsivePadding>
						<div className="space-y-4">
							<h3 className="text-sm font-medium text-zinc-300">Item Descriptions</h3>
...
/>`}</code>
					...
					<Card variant="primary" responsivePadding>
						<div className="space-y-4">
							<h3 className="text-sm font-medium text-zinc-300">Keyboard Shortcuts</h3>
...
/>`}</code>
					...
					<Card variant="primary" responsivePadding>
						<div className="space-y-4">
							<h3 className="text-sm font-medium text-zinc-300">Loading States</h3>
							<Menu triggerLabel="With Loading">
								<MenuItem label="Save Changes" icon={<FiSettings />} loading onClick={() => {}} />
								<MenuItem
									label="Export Data"
									icon={<FiEdit />}
...
/>`}</code>
					...
					<Card variant="primary" responsivePadding>
						<div className="space-y-4">
							<h3 className="text-sm font-medium text-zinc-300">Selected/Active State</h3>
...
/>`}</code>
					...
					<Card variant="primary" responsivePadding>
						<div className="space-y-4">
							<h3 className="text-sm font-medium text-zinc-300">Menu Sections</h3>
							...
							<div className="flex flex-wrap items-center gap-4">
								<Menu triggerLabel="Opens Right (default)">
									<MenuItem label="Settings" icon={<FiSettings />}>
										<Menu>
											<MenuItem label="Account" icon={<FiUser />} href="/settings/account" />
											<MenuItem
												label="Preferences"
												icon={<FiSettings />}
								...
								<Menu triggerLabel="Opens Left">
									<MenuItem label="Settings" icon={<FiSettings />} submenuPlacement="left">
										<Menu>
											<MenuItem label="Account" icon={<FiUser />} href="/settings/account" />
											<MenuItem
												label="Preferences"
...
<MenuItem label="Settings" submenuPlacement="left">
  <Menu>...</Menu>
					...
					<Card variant="primary" responsivePadding>
						<div className="space-y-4">
							<h3 className="text-sm font-medium text-zinc-300">Custom Item Rendering</h3>
										...
										<div className="flex items-start gap-3 w-full py-1">
											...
											<div className="flex-1 min-w-0">
												<div className="flex items-center justify-between gap-2">
													...
													<span className="text-xs text-zinc-400 shrink-0">2m ago</span>
												</div>
    ...
    <div>
      ...
      <p>Message preview...</p>
				...
				<section className="space-y-4">
					...
					<Card variant="primary" responsivePadding>
						<div className="space-y-4">
							<h3 className="text-sm font-medium text-zinc-300">Controlled State</h3>
							<div className="flex items-center gap-4">
								<Menu
							...
							<p className="text-xs text-zinc-500">Menu is {menuOpen ? "open" : "closed"}</p>
							<pre className="text-xs bg-zinc-900/50 rounded-lg p-4 overflow-x-auto">
...
>
  <MenuItem label="Item" />
					...
					<Card variant="primary" responsivePadding>
						<div className="space-y-4">
							<h3 className="text-sm font-medium text-zinc-300">Custom Trigger</h3>
							<div className="flex flex-wrap items-center gap-4">
								<Menu
									trigger={
...
<Menu triggerLabel="Menu">
  <MenuItem label="Item" />
					...
					<Card variant="primary" responsivePadding>
						<div className="space-y-4">
							<h3 className="text-sm font-medium text-zinc-300">Placement & Width</h3>
							<div className="flex flex-wrap items-center gap-4">
...
>
  <MenuItem label="Item" />
				...
				<section className="space-y-4">
					...
					<Card variant="primary" responsivePadding>
						<div className="space-y-4">
							<p className="text-sm text-zinc-400">Example of how Menu would be used in a Navbar</p>
