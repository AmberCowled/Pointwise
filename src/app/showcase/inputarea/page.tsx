	...
	return (
		<div className="relative min-h-screen bg-zinc-950 text-zinc-100 overflow-hidden">
			...
			<div className="relative z-10 max-w-4xl mx-auto px-6 py-12 space-y-12">
				<div>
					<h1 className="text-3xl font-bold mb-2">InputArea Component Showcase</h1>
				...
				<section className="space-y-4">
					...
					<p className="text-xs text-zinc-500">Different sizes for different use cases</p>
					<div className="space-y-4 max-w-md">
						<InputArea
							size="xs"
							...
							rows={2}
						/>
						<InputArea size="sm" placeholder="Small" name="sm-size" defaultValue="" rows={3} />
						<InputArea size="md" placeholder="Medium (default)" name="md-size" defaultValue="" />
						<InputArea size="lg" placeholder="Large" name="lg-size" defaultValue="" rows={5} />
						<InputArea
							size="xl"
				...
				<section className="space-y-4">
					...
					<p className="text-xs text-zinc-500">Provide context and guidance to users</p>
					<div className="space-y-4 max-w-md">
						<InputArea
							label="Task Notes"
				...
				<section className="space-y-4">
					...
					<p className="text-xs text-zinc-500">Display validation errors and feedback</p>
					<div className="space-y-4 max-w-md">
						<InputArea
							label="Notes"
				...
				{/* Disabled States */}
				<section className="space-y-4">
					<h2 className="text-xl font-semibold text-zinc-200">Disabled States</h2>
				...
				{/* Character Count */}
				<section className="space-y-4">
					<h2 className="text-xl font-semibold text-zinc-200">Character Count</h2>
					<p className="text-xs text-zinc-500">
				...
				<section className="space-y-4">
					...
					<p className="text-xs text-zinc-500">Visual progress indicator for character limits</p>
					<div className="space-y-4 max-w-md">
						<InputArea
				...
				{/* Task Notes Example */}
				<section className="space-y-4">
					<h2 className="text-xl font-semibold text-zinc-200">Task Notes Example</h2>
					<p className="text-xs text-zinc-500">
				...
				<section className="space-y-4">
					...
					<p className="text-xs text-zinc-500">Multiple InputAreas working together in a form</p>
					<form
