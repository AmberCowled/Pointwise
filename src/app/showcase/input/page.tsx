		...
		<div className="relative min-h-screen bg-zinc-950 text-zinc-100 overflow-hidden">
			...
			<div className="relative z-10 max-w-4xl mx-auto px-6 py-12 space-y-12">
				...
				<section className="space-y-4">
					...
					<p className="text-xs text-zinc-500">Size variants matching Button component system</p>
					<div className="space-y-4 max-w-md">
						<Input size="xs" placeholder="Extra small (xs)" name="size-xs" defaultValue="" />
						<Input size="sm" placeholder="Small (sm)" name="size-sm" defaultValue="" />
						<Input size="md" placeholder="Medium (md) - default" name="size-md" defaultValue="" />
						<Input size="lg" placeholder="Large (lg)" name="size-lg" defaultValue="" />
						<Input size="xl" placeholder="Extra large (xl)" name="size-xl" defaultValue="" />
					</div>
				</section>
				...
				<section className="space-y-4">
					...
					<p className="text-xs text-zinc-500">Different HTML input types supported</p>
					<div className="space-y-4 max-w-md">
						<Input label="Text" placeholder="Enter text" defaultValue="" />
						<Input type="email" label="Email" placeholder="you@example.com" defaultValue="" />
						<Input type="password" label="Password" placeholder="••••••••" defaultValue="" />
						<Input type="number" label="Number" placeholder="0" defaultValue="0" />
				...
				<section className="space-y-4">
					<h2 className="text-xl font-semibold text-zinc-200">With Label & Description</h2>
				...
				{/* Disabled State */}
				<section className="space-y-4">
					<h2 className="text-xl font-semibold text-zinc-200">Disabled State</h2>
					<div className="space-y-4 max-w-md">
						<Input
				...
				<section className="space-y-4">
					<h2 className="text-xl font-semibold text-zinc-200">Interactive Form Example</h2>
					<p className="text-xs text-zinc-500">Controlled inputs with validation</p>
					<form
				...
				<section className="space-y-4">
					<h2 className="text-xl font-semibold text-zinc-200">Auth Form Pattern Example</h2>
					<p className="text-xs text-zinc-500">Using Input component for authentication forms</p>
					<div className="space-y-4 max-w-md">
						<Input
							variant="secondary"
							size="sm"
				...
				<section className="space-y-4">
					<h2 className="text-xl font-semibold text-zinc-200">Task Modal Pattern Example</h2>
					<p className="text-xs text-zinc-500">Using Input component for task forms</p>
					<div className="space-y-4 max-w-md">
						<Input
							variant="primary"
							size="md"
				...
				{/* Search Bar Pattern */}
				<section className="space-y-4">
					<h2 className="text-xl font-semibold text-zinc-200">Search Bar Pattern</h2>
					<p className="text-xs text-zinc-500">
				...
				<section className="space-y-4">
					...
					<p className="text-xs text-zinc-500">All combinations of variants and sizes</p>
					<div className="space-y-6">
						{(["xs", "sm", "md", "lg", "xl"] as const).map((size) => (
							<div key={size} className="space-y-3">
								<h3 className="text-sm font-medium text-zinc-300 capitalize">Size: {size}</h3>
				...
				<section className="space-y-4">
					<h2 className="text-xl font-semibold text-zinc-200">Password Toggle Feature</h2>
					<p className="text-xs text-zinc-500">
				...
				<section className="space-y-4">
					<h2 className="text-xl font-semibold text-zinc-200">Character Count Feature</h2>
					<p className="text-xs text-zinc-500">
						Built-in character counting with color thresholds and progress bar option
					</p>
					<div className="space-y-4 max-w-md">
						<Input
							variant="primary"
