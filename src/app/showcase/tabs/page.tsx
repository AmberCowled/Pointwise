		...
		<div className="relative min-h-screen bg-zinc-950 text-zinc-100 overflow-hidden">
			...
			<div className="relative z-10 max-w-4xl mx-auto px-6 py-12 space-y-12">
				...
				<section className="space-y-4">
					...
					<p className="text-xs text-zinc-500">Simple two-tab example (like authentication page)</p>
				...
				<section className="space-y-4">
					...
					<p className="text-xs text-zinc-500">Different visual styles for tabs</p>
				...
				<section className="space-y-4">
					...
					<p className="text-xs text-zinc-500">Different size options for tabs</p>
					<div className="space-y-6">
						<div className="space-y-2">
						...
						<div className="space-y-2">
							<h3 className="text-sm font-medium text-zinc-400">Medium (Default)</h3>
							<Tabs
								items={[
				...
				<section className="space-y-4">
					...
					<p className="text-xs text-zinc-500">Tabs can include icons alongside labels</p>
					<Tabs
						items={[
				...
				<section className="space-y-4">
					...
					<p className="text-xs text-zinc-500">Tabs can be disabled individually</p>
					<Tabs
						items={[
				...
				<section className="space-y-4">
					...
					<p className="text-xs text-zinc-500">Tabs component supports any number of tabs</p>
					<Tabs
						items={[
							{ id: "tab1", label: "First" },
				...
				<section className="space-y-4">
					...
					<p className="text-xs text-zinc-500">Tabs can take full width or be inline</p>
					<div className="space-y-6">
						<div className="space-y-2">
							<h3 className="text-sm font-medium text-zinc-400">Full Width (Default)</h3>
							<Tabs
								items={[
									{ id: "tab1", label: "Tab 1" },
									{ id: "tab2", label: "Tab 2" },
				...
				<section className="space-y-4">
					<h2 className="text-xl font-semibold text-zinc-200">Filter Variant Use Cases</h2>
					<p className="text-xs text-zinc-500">
						The filter variant is designed for option selectors and filters, similar to Analytics
						range selectors
					</p>
					<div className="space-y-6">
						<div className="space-y-2">
						...
						<div className="space-y-2">
							<h3 className="text-sm font-medium text-zinc-400">Filter Variant Sizes</h3>
				...
				{/* Real-world Example */}
				<section className="space-y-4">
					<h2 className="text-xl font-semibold text-zinc-200">Real-world Example</h2>
					<p className="text-xs text-zinc-500">Example usage in a card with content switching</p>
					<Card variant="primary" responsivePadding>
						<Tabs
							items={[
						...
						<div className="mt-6">
							{iconTab === "inbox" && (
								<div className="space-y-2">
									...
									<p className="text-sm text-zinc-400">Your inbox messages will appear here.</p>
								</div>
							)}
							{iconTab === "starred" && (
								<div className="space-y-2">
									<h3 className="text-lg font-semibold">Starred</h3>
									<p className="text-sm text-zinc-400">Your starred items will appear here.</p>
								</div>
							)}
							{iconTab === "settings" && (
								<div className="space-y-2">
									<h3 className="text-lg font-semibold">Settings</h3>
									<p className="text-sm text-zinc-400">Your settings will appear here.</p>
								</div>
							)}
						</div>
					</Card>
