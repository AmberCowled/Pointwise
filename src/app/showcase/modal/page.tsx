      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 py-12 space-y-12">
          ...
          >
            ...
            <ModalBody>
              ...
              <p className="text-zinc-400 mt-4">
                ...
                Notice that body scrolling is locked when this modal is open.
              </p>
            </ModalBody>
        ...
        <section className="space-y-4">
          ...
          <Modal
            ...
            onClose={() =>
              setAnimationModal({ ...animationModal, open: false })
            }
            size="md"
          ...
          >
            ...
            <ModalBody>
              <p className="text-zinc-300">
                ...
                <code className="text-indigo-400">{animationModal.type}</code>{' '}
                animation is applied to the panel.
              </p>
            </ModalBody>
            <ModalFooter align="end">
              <Button
        ...
        <section className="space-y-4">
          ...
          <p className="text-xs text-zinc-500">
            Modal with loading overlay and custom message
          </p>
          <Button
            variant="primary"
            size="md"
          ...
          >
            ...
            <ModalBody>
              <p className="text-zinc-300">
                This modal demonstrates the loading overlay feature. The loading
                overlay appears above the modal content with a spinner and
                custom message.
              </p>
            </ModalBody>
            <ModalFooter align="end">
        ...
        <section className="space-y-4">
          ...
          >
            ...
            <ModalBody>
              <p className="text-zinc-300">
                This modal header includes an icon positioned to the left of the
                title. You can also position icons to the right.
              </p>
            </ModalBody>
            <ModalFooter align="end">
              <Button
        ...
        <section className="space-y-4">
          ...
          <Modal
            ...
            onClose={() =>
              setHeaderSizeModal({ ...headerSizeModal, open: false })
            }
            size="md"
          >
            <ModalHeader
            ...
            <ModalBody>
              <p className="text-zinc-300">
                Notice how the title and subtitle font sizes change based on the
                size prop.
              </p>
            </ModalBody>
            <ModalFooter align="end">
              ...
              <div className="space-y-4">
                {Array.from({ length: 20 }, (_, i) => (
                  <p key={i} className="text-zinc-300">
                    ...
                    The modal body has a max height of 300px with smooth
                    scrolling enabled.
                  </p>
                ))}
              </div>
              ...
              <div className="space-y-4">
                <div className="border border-white/10 rounded-lg p-4 bg-white/5">
                  ...
                  <p className="text-xs text-zinc-400">
                    This section uses padding=&quot;lg&quot; for more spacious
                    content.
                  </p>
                </div>
                <div className="border border-white/10 rounded-lg p-4 bg-white/5">
                  ...
                  <p className="text-xs text-zinc-400">
                    You can also use padding=&quot;none&quot;,
                    padding=&quot;sm&quot;, or padding=&quot;md&quot;.
                  </p>
                </div>
              </div>
            </ModalBody>
        ...
        <section className="space-y-4">
          ...
          <Modal
            ...
            onClose={() =>
              setFooterSizeModal({ ...footerSizeModal, open: false })
            }
            size="md"
          >
            <ModalHeader
            ...
            <ModalBody>
              <p className="text-zinc-300">
                Notice how the footer padding and gap spacing change based on
                the size prop.
              </p>
            </ModalBody>
        ...
        <section className="space-y-4">
          ...
          <Modal
            ...
            onClose={() =>
              setCloseVariantModal({ ...closeVariantModal, open: false })
            }
            size="md"
          >
            <ModalHeader
              ...
              <div className="space-y-4">
                <p className="text-zinc-300">
                  ...
                  <code className="text-indigo-400">
                    {closeVariantModal.variant}
                  </code>{' '}
                  variant. You can also use ModalCloseButton standalone:
                </p>
        ...
        <section className="space-y-4">
          ...
          <div className="flex flex-wrap gap-3">
            <Button
              ...
              size="sm"
              onClick={() =>
                setCloseBehaviorModal({ overlayClick: true, escape: true })
              }
            >
            ...
            <Button
              ...
              size="sm"
              onClick={() =>
                setCloseBehaviorModal({ overlayClick: false, escape: true })
              }
            >
              Overlay Disabled
            </Button>
            <Button
              ...
              size="sm"
              onClick={() =>
                setCloseBehaviorModal({ overlayClick: true, escape: false })
              }
            >
              Escape Disabled
            </Button>
            <Button
              ...
              size="sm"
              onClick={() =>
                setCloseBehaviorModal({ overlayClick: false, escape: false })
              }
            >
              Both Disabled
            </Button>
          ...
          >
            ...
            <ModalBody>
              <p className="text-zinc-300">
                Try clicking the overlay or pressing Escape. The behavior is
                controlled by the{' '}
          ...
          >
            ...
            <ModalBody>
              <p className="text-zinc-300 mb-4">
                This modal uses <code className="text-indigo-400">onOpen</code>{' '}
                and <code className="text-indigo-400">onAfterClose</code>{' '}
                callbacks. Open and close this modal to see the events logged
                below.
              </p>
              {eventLog.length > 0 && (
                <div className="border border-white/10 rounded-lg p-4 bg-white/5">
            ...
            <ModalFooter align="end">
              <Button
                variant="primary"
                size="md"
                onClick={() => setEventCallbackModalOpen(false)}
              >
                Close
              </Button>
            </ModalFooter>
        ...
        <section className="space-y-4">
          ...
          >
            ...
            <ModalBody>
              <p className="text-zinc-300">
                This is a nested modal. Notice how it appears above the outer
                modal. The z-index is automatically calculated based on nesting
                depth (each level adds 10).
              </p>
            </ModalBody>
            <ModalFooter align="end">
              <Button
        ...
        <section className="space-y-4">
          ...
          <p className="text-xs text-zinc-500">
            Reusable X icon component with size variants
          </p>
