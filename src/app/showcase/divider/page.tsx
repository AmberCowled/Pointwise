			...
			<div className="relative z-10 max-w-4xl mx-auto px-6 py-12 space-y-12">
				<div>
					...
					<p className="text-sm text-zinc-400">
						Comprehensive display of all divider variants, orientations, and use cases
					</p>
				</div>

				{/* Basic Horizontal Dividers */}
				<section className="space-y-4">
					<h2 className="text-xl font-semibold text-zinc-200">Basic Horizontal Dividers</h2>
					<div className="space-y-6">
						<div>
							<p className="text-sm text-zinc-400 mb-2">Subtle variant</p>
							<div className="bg-zinc-900/40 p-4 rounded-lg">
								<p className="text-sm text-zinc-300 mb-4">Content above the divider</p>
								<Divider variant="subtle" />
								<p className="text-sm text-zinc-300 mt-4">Content below the divider</p>
							</div>
						</div>
						<div>
				...
				<section className="space-y-4">
					<h2 className="text-xl font-semibold text-zinc-200">Horizontal Dividers with Labels</h2>
					<div className="space-y-6">
						<div>
							<p className="text-sm text-zinc-400 mb-2">Subtle with &quot;or&quot; label</p>
							<div className="bg-zinc-900/40 p-4 rounded-lg">
								<p className="text-sm text-zinc-300 mb-4">Sign in with email</p>
								<Divider variant="subtle" label="or" />
								<p className="text-sm text-zinc-300 mt-4">Sign in with social</p>
							</div>
						</div>
						<div>
							<p className="text-sm text-zinc-400 mb-2">Prominent with custom label</p>
							<div className="bg-zinc-900/40 p-4 rounded-lg">
						...
						<div>
							<p className="text-sm text-zinc-400 mb-2">With custom label content</p>
							<div className="bg-zinc-900/40 p-4 rounded-lg">
				...
				{/* Spacing Variants */}
				<section className="space-y-4">
					<h2 className="text-xl font-semibold text-zinc-200">Spacing Variants</h2>
					<div className="space-y-6">
						{(["none", "xs", "sm", "md", "lg", "xl"] as const).map((spacing) => (
							<div key={spacing}>
								<p className="text-sm text-zinc-400 mb-2">Spacing: {spacing}</p>
								<div className="bg-zinc-900/40 p-4 rounded-lg">
				...
				{/* Vertical Dividers */}
				<section className="space-y-4">
					<h2 className="text-xl font-semibold text-zinc-200">Vertical Dividers</h2>
					<div className="space-y-6">
						<div>
							<p className="text-sm text-zinc-400 mb-2">Basic vertical divider</p>
							<div className="bg-zinc-900/40 p-4 rounded-lg">
								<div className="flex items-center h-20">
									<div className="flex-1 text-sm text-zinc-300">Left content</div>
									<Divider orientation="vertical" variant="subtle" />
									<div className="flex-1 text-sm text-zinc-300">Right content</div>
								</div>
							</div>
						</div>
						<div>
							<p className="text-sm text-zinc-400 mb-2">Prominent vertical divider</p>
							<div className="bg-zinc-900/40 p-4 rounded-lg">
								<div className="flex items-center h-20">
									<div className="flex-1 text-sm text-zinc-300">Left content</div>
						...
						<div>
							<p className="text-sm text-zinc-400 mb-2">Vertical divider with label</p>
							<div className="bg-zinc-900/40 p-4 rounded-lg">
								<div className="flex items-center h-32">
									<div className="flex-1 text-sm text-zinc-300">Left section</div>
									<Divider orientation="vertical" variant="subtle" label="VS" spacing="sm" />
									<div className="flex-1 text-sm text-zinc-300">Right section</div>
								</div>
							</div>
						</div>
					</div>
					...
					<div className="space-y-6">
						...
						<div className="space-y-2">
							...
							<div className="bg-zinc-900/40 p-6 rounded-lg space-y-4">
								<div>
									<h4 className="text-base font-semibold mb-2">Profile Settings</h4>
									<p className="text-sm text-zinc-400">
						...
						<div className="space-y-2">
							...
							<div className="bg-zinc-900/40 p-4 rounded-lg">
								<div className="flex h-48">
									...
									<Divider orientation="vertical" variant="prominent" label="VS" spacing="lg" />
									<div className="flex-1">
				...
				<section className="space-y-4">
					<h2 className="text-xl font-semibold text-zinc-200">Full Width vs Inline</h2>
					<div className="space-y-6">
						<div>
						...
						<div>
							<p className="text-sm text-zinc-400 mb-2">Inline (not full width)</p>
							<div className="bg-zinc-900/40 p-4 rounded-lg">
								<p className="text-sm text-zinc-300 mb-4">Content</p>
								<div className="flex justify-center">
									<Divider variant="subtle" fullWidth={false} className="w-32" />
								</div>
								<p className="text-sm text-zinc-300 mt-4">Content</p>
							</div>
						</div>
