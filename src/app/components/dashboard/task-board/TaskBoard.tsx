...
export default function TaskBoard({
	...
	const [internalViewMode, setInternalViewMode] = useState<TaskBoardViewMode>("day");
			...
			>
				...
				<div className="mt-5" suppressHydrationWarning>
					{!hasHydrated ? (
						...
						<TaskBoardEmptyState selectedDateLabel={selectedDateLabel} searchQuery={searchQuery} />
					)}
				</div>
			</TaskSectionCard>
