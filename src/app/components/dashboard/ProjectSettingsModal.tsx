...
export function ProjectSettingsModal({
	...
	const errorMessage = error ? getErrorMessage(error, "An error occurred") : null;
						...
						<div className="space-y-5">
							...
							<div className="px-4 py-3 bg-rose-500/10 border border-rose-400/20 rounded-lg">
								...
								<p className="text-zinc-400 text-sm">
									This will permanently delete the project and all associated tasks. All members
							...
							<div>
								<label className="block text-sm font-medium text-zinc-300 mb-2">
									Type the project name <span className="font-semibold">{name}</span> to confirm
									deletion:
								</label>
								<Input
									placeholder={name}
