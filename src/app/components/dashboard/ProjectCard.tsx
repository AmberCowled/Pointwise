        ...
        <div className="relative p-6">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div className="flex items-center gap-2 text-sm text-zinc-400">
              ...
              <span>{project.projectUserIds.length} {project.projectUserIds.length === 1 ? 'member' : 'members'}</span>
            </div>
          </div>

          {/* Role badge */}
          <div className="flex items-center justify-between">
            <span className={`inline-flex items-center px-2.5 py-1 rounded-md text-xs font-medium border ${roleColor}`}>
              {roleLabel}
            </span>
