...
export default function BrandHeaderV2({ className, size = "default" }: BrandHeaderV2Props) {
  ...
  return (
    <Container fullWidth={false} gap="sm" className={className} direction="horizontal">
      <div className={clsx("relative shrink-0", container)}>
        <Image src="/logo.png" alt="Pointwise" width={image} height={image} className="object-contain" priority />
      </div>
