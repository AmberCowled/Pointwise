 ...
 * @internal - Used by ModalV2.Prompt static method
 */
export function PromptModalComponent({ id, options }: { id: string; options: PromptModalOptions }) {
	...
	return (
		<ModalV2 id={id} size={options.size || "md"}>
			<ModalV2.Header title={options.title || "Prompt"} showCloseButton />
			<ModalV2.Body>
			...
			<ModalV2.Footer align="end">
				<Button variant={options.cancelVariant || "secondary"} onClick={handleCancel}>
