...
type CardV2Variants = "primary" | "secondary" | "danger";
type CardV2Sizes = "xs" | "sm" | "md" | "lg" | "xl";
type CardV2Flex = "shrink" | "default" | "grow";

/**
 * Custom props for the CardV2 component
 *
 ...
 */
export interface CardV2CustomProps {
  /**
   * Visual variant style
   * @default 'primary'
   */
  variant?: CardV2Variants;
...
/**
 * Props for the CardV2 component
 */
export type CardV2Props = CardV2CustomProps &
  Omit<React.HTMLAttributes<HTMLDivElement>, "onClick" | "className">;

const baseStyle = "bg-zinc-900/60 backdrop-blur";

const variantStyles: Record<CardV2Variants, string> = {
...
const sizeStyles: Record<CardV2Sizes, string> = {
  xs: "p-2",
  sm: "p-3",
  md: "p-4",
  lg: "p-6",
...
const flexClasses: Record<CardV2Flex, string> = {
...
/**
 * CardV2 - Simplified card component built on Container
 *
 * Much simpler than CardV2 by leveraging Container's built-in onClick handling and layout capabilities.
