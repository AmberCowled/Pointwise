...
/**
 * Props for the InputSelectV2 component
 */
...
/**
 * InputSelectV2 - Dropdown select component with variants, sizes, and flexible layout
 *
 * **Props:**
						...
						>
							<ListboxOptions
								...
								style={
									buttonWidth
										? {
												width: isMobile ? "100%" : `${Math.max(buttonWidth, 160)}px`,
											}
