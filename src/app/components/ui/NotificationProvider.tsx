...
import type { NotificationPosition, NotificationSize, NotificationVariant } from "./Notification";
		...
		<NotificationContext.Provider value={value}>
			...
			<div
				className={clsx(
					...
					position.includes("top") || position.includes("bottom") ? "flex flex-col gap-3" : "",
				)}
				style={{
