...
const activeTabStyles: Record<TabsVariant, string> = {
	...
	filter: "border-indigo-400/80 bg-indigo-500/20 text-white shadow-inner shadow-indigo-500/30",
};
...
const inactiveTabStyles: Record<TabsVariant, string> = {
	...
	filter: "border-white/10 text-zinc-400 hover:border-indigo-400/60 hover:text-white",
};
				...
				return (
					<button
						...
						className={clsx(
							...
							!isDisabled && (isActive ? activeTabStyles[variant] : inactiveTabStyles[variant]),
						)}
					>
