 ...
 */
export function toRecurrenceType(value: RecurrenceValue | string): RecurrenceType | null {
	if (value === "none") return null;
	const upper = value.toUpperCase();
	return RECURRENCE_TYPES.includes(upper as RecurrenceType) ? (upper as RecurrenceType) : null;
}
