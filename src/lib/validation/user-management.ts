 ...
 */
export function parseAddUserBody(body: unknown): ValidationResult<AddUserRequest> {
 ...
 */
export function parseUpdateUserRoleBody(body: unknown): ValidationResult<UpdateUserRoleRequest> {
	if (!body || typeof body !== "object") {
		return {
			success: false,
			error: "Invalid request body",
