...
const TASK_START_TIME_SCHEMA = z
	.string()
	.regex(/^\d{2}:\d{2}$/)
	.optional()
	.nullable();
...
export const TaskV2Schema = z.object({
	...
	startTime: TASK_START_TIME_SCHEMA,
	dueDate: TASK_DUE_DATE_RESPONSE_SCHEMA,
	dueTime: TASK_DUE_TIME_SCHEMA,
...
export const UpdateTaskRequestSchema = z.object({
	...
	startTime: TASK_START_TIME_SCHEMA.optional(),
	dueDate: TASK_DUE_DATE_SCHEMA.optional(),
	dueTime: TASK_DUE_TIME_SCHEMA.optional(),
