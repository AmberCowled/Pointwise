 ...
 */
export function userIsAdmin(project: { adminUserIds: string[] }, userId: string): boolean {
 ...
 */
export function userCanManageProject(project: { adminUserIds: string[] }, userId: string): boolean {
...
export async function verifyProjectAccess(
	...
	const role = getUserRoleInProject(
		project as unknown as {
			adminUserIds: string[];
			projectUserIds: string[];
			viewerUserIds: string[];
