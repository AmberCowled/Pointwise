...
export async function createTask(request: CreateTaskRequest, userId: string): Promise<PrismaTaskV2> {
...
export async function updateTask(taskId: string, request: UpdateTaskRequest, userId: string): Promise<PrismaTaskV2> {
