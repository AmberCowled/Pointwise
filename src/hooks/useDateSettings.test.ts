...
describe("useDateSettings", () => {
	...
	it("should initialize with provided values", () => {
		...
		expect(result.current.selectedDate).toEqual(defaultOptions.initialSelectedDate);
	...
	it("should maintain selectedDateRef reference", () => {
		...
		expect(result.current.selectedDateRef.current).toEqual(defaultOptions.initialSelectedDate);
	});
