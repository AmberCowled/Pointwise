...
describe('useUpcomingTasks', () => {
  ...
  it('should filter out completed tasks', () => {
    const tasks = [
      createMockTask({ id: '1', completed: true, dueDate: new Date('2025-12-20T09:00:00Z') }),
      createMockTask({ id: '2', completed: false, dueDate: new Date('2025-12-21T09:00:00Z') }),
    ];
  ...
  it('should filter out tasks already in scheduled tasks', () => {
    const scheduledTask = createMockTask({ id: '1', dueDate: new Date('2025-12-20T09:00:00Z') });
    const upcomingTask = createMockTask({ id: '2', dueDate: new Date('2025-12-21T09:00:00Z') });
